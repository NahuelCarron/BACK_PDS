package ar.edu.unsam.phm.repositories

import ar.edu.unsam.phm.controller.dto.AmigoDTO
import ar.edu.unsam.phm.controller.dto.PosibleAmigo
import ar.edu.unsam.phm.domains.RelacionAmigo
...
interface AmigosRepositorio: CrudRepository<RelacionAmigo, Long> {
    ...
    @Query("""
       SELECT new ar.edu.unsam.phm.controller.dto.AmigoDTO(am.id, am.nombre, am.apellido, am.profileUrl, am.pais)
    ...
    @Query("""
           SELECT new ar.edu.unsam.phm.controller.dto.PosibleAmigo(u.id, u.nombre, u.apellido)
            FROM Usuario u
